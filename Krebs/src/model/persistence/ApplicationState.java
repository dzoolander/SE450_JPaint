...
public class ApplicationState implements IApplicationState, Serializable {
    ...
    public ShapeOptions getShapeOptions () {
    	options.setPrimaryColor(activePrimaryColor);
    	options.setSecondaryColor(activeSecondaryColor);
    	options.setShadingType(activeShapeShadingType);
    	options.setShapeType(activeShapeType);
    	return options;
    }
